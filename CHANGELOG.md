...
## 0.5.0 - 2026-05-15
### Added
- Support for `true` type hint to `TypeReflection` (since PHP 8.2)

### Changed
- Dropped support for PHP versions prior to 8.2
- Marked classes as `readonly`
...
## 0.4.3 - 2025-10-24
### Fixed
- Deprecation warning in `TypeReflection` constructor
